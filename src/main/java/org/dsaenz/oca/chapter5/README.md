### No multiple state inheritance (no extend multiple classes)
...
### Multiple implementation inheritance (default methods multiple interfaces)
...
### Multiple type inheritance (interfaces)
